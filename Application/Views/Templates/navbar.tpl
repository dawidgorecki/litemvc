            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="dropdown01" data-toggle="dropdown"
                       aria-haspopup="true" aria-expanded="false">Example pages</a>
                    <div class="dropdown-menu" aria-labelledby="dropdown01">
                        <a class="dropdown-item {if \Libraries\Core\View::checkForActive('Page@pricing')}active{/if}"
                           href="{\Libraries\Http\Request::getSiteUrl()}/pages/pricing">Pricing</a>
                        <a class="dropdown-item {if \Libraries\Core\View::checkForActive('Page@checkout')}active{/if}"
